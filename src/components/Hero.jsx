            ...
            <div className="relative h-full flex flex-col justify-center items-start text-left px-6 md:px-12 lg:px-24 z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <a href="#soil-analysis"
                        className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-8 py-3 rounded-lg text-lg font-medium transition-colors shadow-md hover:shadow-lg">
                        Analyze Your Soil
                    </a>
                    <a
                        href="#features"
